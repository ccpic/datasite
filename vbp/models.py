...
D_MAIN_SPEC = {
    ...
    "盐酸艾司洛尔注射液": {
        ...
        "50mL:1g": 10,
        "100ml:2g": 20,
        "250ml:盐酸艾司洛尔 2.5g与氯化钠1.475g": 25,
    },
    "氨茶碱注射液": {
        "10ml:250mg": 1,
        "20ml:0.5g": 2,
    ...
    "钆特酸葡胺注射液": {
        "15ml:5.6535g": 1,
        "20ml:7.538g": 7.538 / 5.6535,
        "100ml:37.69g": 37.69 / 5.6535,
        "10ml:3.769g": 3.769 / 5.6535,
        "5ml:1.8845g": 1.8845 / 5.6535,
    },
    "枸橼酸坦度螺酮片": {
        "5mg": 1,
        "10mg": 2,
...
class Tender(models.Model):
    ...
    def tender_end(self):
        ...
        elif "第九轮" in self.vol or "第十轮" in self.vol:  # 第九轮和第十轮集采规则
